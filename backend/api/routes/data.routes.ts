...
// HRM Routes
router.get('/hrm/directory', providerPermit as any, getTeamMembers as any);
router.get('/hrm/roles', providerPermit as any, getRolesAndPermissions as any);
router.get('/hrm/permissions', providerPermit as any, getAllPermissions as any);
